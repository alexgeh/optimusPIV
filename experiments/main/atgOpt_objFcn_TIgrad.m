function J = atgOpt_objFcn_TIgrad(freq, alpha, relBeta, ampgrad, offsetgrad)
...
[J, J_comp, metrics, fields] = objEval_turbulenceIntensity_TIgrad(PIVfolder);

disp("Current: J = " + num2str(J) + ...
    ", J_TI = " + num2str(J_comp.J_TI) + ...
    ", J_hom_dTIdy = " + num2str(J_comp.J_hom_dTIdy) + ...
