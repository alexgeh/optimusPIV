...
wTI = 0.814;  % weight for target TI deviation
wH1 = 0.089;  % weight for velocity gradient homogeneity
wH2 = 0.024;  % weight for turbulence intensity homogeneity
wH3 = 0.038;  % weight for homogeneity of turbulence intensity coefficient of variation
wA  = 0.035;  % weight for anisotropy
